...
users = `create table if not exists users(
  ...
  avator VARCHAR(100) NOT NULL default 'http://oatl31bw3.bkt.clouddn.com/735510dbjw8eoo1nn6h22j20m80m8t9t.jpg',
...
posts = `create table if not exists posts(
  ...
  moment VARCHAR(100) NOT NULL,
  comments VARCHAR(200) NOT NULL DEFAULT '暂无评论',
...
let updatePost = values => {
  let _sql = `update posts set title = ?, conent = ? where id = ?;`
